...
describe('Seasons @unit', function () {
  ...
  describe('Upcoming Suit Season', function () {
    it('should returns the upcoming suit season for SP', function () {
      var calendar = new EcCalendar('SP17')
      var wn17 = calendar.findSeason('WN17')

      expect(calendar.upcomingSuitSeason).to.equal(wn17)
    })
    it('should returns the upcoming suit season for SM', function () {
      var calendar = new EcCalendar('SM17')
      var wn17 = calendar.findSeason('WN17')

      expect(calendar.upcomingSuitSeason).to.equal(wn17)
    })
    it('should returns the upcoming suit season for FA', function () {
      var calendar = new EcCalendar('FA17')
      var sm18 = calendar.findSeason('SM18')

      expect(calendar.upcomingSuitSeason).to.equal(sm18)
    })
    it('should returns the upcoming suit season for WN', function () {
      var calendar = new EcCalendar('WN17')
      var sm18 = calendar.findSeason('SM18')
